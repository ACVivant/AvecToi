...
public class EventAdapter extends FirestoreRecyclerAdapter<SosEvent, EventAdapter.EventViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull EventViewHolder eventViewHolder, int i, @NonNull SosEvent sosEvent) {
        ...
        Drawable top;
        switch (themeIndex) {
            case 0: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_0);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 1: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_1);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 2: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_2);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 3: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_3);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 4: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_4);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 5: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_5);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 6: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_6);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 7: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_7);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 8: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_8);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 9: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_9);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 10: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_10);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 11: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_11);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 12: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_12);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 13: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_13);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 14: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_14);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
            case 15: top = eventViewHolder.itemView.getContext().getResources().getDrawable(R.drawable.ic_topic_15);
                eventViewHolder.themeRV.setCompoundDrawablesWithIntrinsicBounds(null, top , null, null);
                return;
